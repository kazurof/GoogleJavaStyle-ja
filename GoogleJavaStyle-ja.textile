...
bq. *Tip:* 画面表示上の大小が違っていても、それぞれのUnicodeコードポイントを１個と数える。例えば全角文字を使う場合、
（https://ja.wikipedia.org/wiki/%E5%85%A8%E8%A7%92%E3%81%A8%E5%8D%8A%E8%A7%92）この規約を厳密に守る必要がある場合は
制限に達する前に改行して良い。
